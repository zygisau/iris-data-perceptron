...
class Perceptron:
    ...
    def __init__(self, activation_function, max_iterations=100, learning_rate=0.5):
    ...
    def __try_assign_weights_as_inputs(self, no_of_inputs, input_weights):
        ...
        if len(input_weights) != (no_of_inputs + BIAS_WEIGHT):
            err_str = "Weights array is either too big or too small. Weights array length: {0}, expected: {1}".format(len(input_weights), (no_of_inputs + BIAS_WEIGHT))
